...
import com.amberclient.modules.render.xray.SettingsStore;
import com.amberclient.events.PlayerRespawnEvent;
import com.amberclient.events.SeedChangedEvent;
import anticope.rejects.utils.Ore;
import com.amberclient.utils.seeds.Seed;
import com.amberclient.utils.seeds.Seeds;
import com.amberclient.events.render.Render3DEvent;
import com.amberclient.events.world.BlockUpdateEvent;
import com.amberclient.events.world.ChunkDataEvent;
import com.amberclient.utils.general.PlayerUtils;
import com.amberclient.events.EventHandler;
...
public class OreSim {
    ...
    public static final Map<Long, Map<Ore, Set<Vec3d>>> chunkRenderers = new ConcurrentHashMap<>();
    public Seed worldSeed = null;
    public static Map<RegistryKey<Biome>, List<Ore>> oreConfig;
    ...
    private void onRender(Render3DEvent event) {
        ...
        if (Seeds.get().getSeed() != null) {
            ...
            int rangeVal = SettingsStore.getInstance().get().getHalfRange();
    ...
    private void onBlockUpdate(BlockUpdateEvent event) {
        if (!SettingsStore.getInstance().get().isActive() || event.newState.isOpaque()) return;
